...
namespace Drogmar_s_Quest
{
    public partial class MediumScreen : UserControl
    {
        ...
        Pen whitePen = new Pen(Color.Blue, 5);
        ...
        private void MediumScreen_Paint(object sender, PaintEventArgs e)
        {
            ...
            e.Graphics.DrawImage(robo1, jedi1.x, jedi1.y, jediSize, jediSize);
            e.Graphics.DrawImage(robo2, jedi2.x, jedi2.y, jediSize, jediSize);
